    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                if (double.TryParse(soA, out a)) //tương đương: if (double.tryparse(soA,out a) == true)
                    // nếu soA là số, số vừa nhập sẽ gán cho biến a, đồng thời đi vào lệnh if
                    // ngược lại, nếu soA là chữ, không làm gì hết và cũng không đi vào lệnh if 
                {              
